        ...
        <div className="overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0 scrollbar-hide">
          <TabsList className="bg-slate-100 border border-slate-200 w-max md:w-auto h-auto p-1">
            ...
            <TabsTrigger value="wallet" className="py-2.5 px-4 rounded-md">
              <DollarSign className="w-4 h-4 mr-2" />
              {t('affiliate.tabs.wallet', 'Wallet & Reports')}
            </TabsTrigger>
          </TabsList>
        </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="shadow-sm border-slate-200">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-slate-500 uppercase">
                  {t('affiliate.stats.status', 'Account Status')}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-2xl font-bold capitalize">
                    ...
                    profile?.status === 'approved'
                      ...
                      : profile?.status || t('common.pending', 'Pending')}
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-sm border-slate-200">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-slate-500 uppercase">
                  {t('affiliate.stats.region', 'Operating Region')}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold truncate">
                  {profile?.city && profile?.state
                    ? `${profile.city}, ${profile.state}`
                    : t('common.all_regions', 'All Regions')}
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-sm border-slate-200">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-slate-500 uppercase">
                  {t('affiliate.stats.commissions', 'Commissions (This Month)')}
                </CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <Card className="border-slate-200 shadow-sm mt-6 bg-white">
            <CardHeader>
              <CardTitle>
                {t('affiliate.welcome', 'Welcome to the Affiliate Dashboard')}
              </CardTitle>
              <CardDescription>
                {t(
            ...
            <CardContent>
              <Button
                ...
                className="font-bold"
              >
                {t('affiliate.start_extraction', 'Start Capturing Offers')}
              </Button>
            </CardContent>
          </Card>
        </TabsContent>
