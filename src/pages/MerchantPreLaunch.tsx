    ...
    <div className="container py-8 px-4 max-w-7xl mx-auto space-y-6 animate-fade-in">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-500">
              Crie ações antecipadas exclusivas para grupos de leads alvo
              (Targeted/Private)
            </p>
          </div>
        </div>
      ...
      <div className="relative mb-6">
        ...
        <Input
          ...
          placeholder="Buscar campanhas de pré-lançamento..."
          value={search}
            ...
            >
              ...
              <div className="flex gap-2 border-t pt-4">
                ...
                <Button
                  ...
                  className="flex-1"
                  onClick={async () => {
                    if (confirm('Deseja excluir este pré-lançamento?')) {
                      await supabase
                        .from('crm_campaigns')
                        .delete()
                        .eq('id', c.id)
