...
BEGIN
  ...
  VALUES 
    ...
    ('m1111111-1111-1111-1111-111111111111'::uuid, 'Louvre Museum Entry', 'Museum', 'production', 'active', 'https://img.usecurling.com/p/200/200?q=museum&color=gray'),
    ('h1111111-1111-1111-1111-111111111111'::uuid, 'Hilton Paris Opera', 'Hotel', 'production', 'active', 'https://img.usecurling.com/p/200/200?q=hotel&color=blue')
